...
public abstract class AbstractXamarinCodegen extends DefaultCodegen implements CodegenConfig {
    ...
    protected Logger LOGGER = LoggerFactory.getLogger(AbstractXamarinCodegen.class);

    public AbstractXamarinCodegen() {
        super();
