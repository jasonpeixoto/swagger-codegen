...
public class XamarinGenerator extends AbstractXamarinCodegen {
    @SuppressWarnings({"unused", "hiding"})
    private static final Logger LOGGER = LoggerFactory.getLogger(XamarinGenerator.class);
    ...
    public String getHelp() {
        return "Generates a Xamarin client library.";
    }
